      ...
      <div className="max-w-5xl mx-auto w-full px-4 pt-6 md:pt-10">
        ...
        <div className="hidden md:flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-sm text-gray-500 font-medium mt-1">Manage your personal information and workspace details.</p>
          </div>
          <button
            onClick={() => setIsEditModalOpen(true)}
            className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 shadow-sm hover:shadow transition-all active:scale-95"
          >
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
          ...
          <div className="w-full md:w-1/3 flex flex-col gap-6">
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-200 flex flex-col items-center text-center">
              ...
              <p className="text-xs md:text-sm font-bold text-gray-500 mt-1 uppercase tracking-widest">{currentUser.designation || 'Team Member'}</p>

              {/* MOBILE EDIT BUTTON */}
              <button
                onClick={() => setIsEditModalOpen(true)}
                className="md:hidden mt-6 w-full bg-blue-50 text-blue-600 border border-blue-100 px-6 py-3 rounded-xl text-sm font-bold flex justify-center items-center gap-2 shadow-sm transition-all active:scale-95"
              >
                <Edit3 className="w-4 h-4" /> Edit Profile
              </button>
            </div>
